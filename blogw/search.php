					...
					<div class="row">
                        ...
                        <?php
                            ...
                            if(isset($_POST["searchbtn"]))
                            {
                                ...
                                if($search_count == 0)
                                {
                                    echo "<h3>Aranan kelime ile ilgili sonuç bulunamadı.</h3>";
                                }
                                else
                                {

                                    while($row = mysqli_fetch_assoc($search_query))    //fetch_assoc satırlar bitene kadar çalış-dbde kaç satır varsa o kadar döner
                                    {
                                        $post_id       = $row["post_id"];
