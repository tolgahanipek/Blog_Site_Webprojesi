...
<section class="page-image page-image-portfolio md-padding">
    <h1 class="text-white text-center">PORTFOLYO</h1>
</section>
			...
			<div class="row text-center">
				<div class="col-md-4 offset-md-4">
					<div class="section-header">
						<h2 class="title">ÇALIŞMALARIMIZ</h2>
					</div>
				</div>
			</div>
        <div class="row">
            ...
            <?php
                ...
                while($row = mysqli_fetch_assoc($select_all_portfolios))
                {
                    ...
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        <a href="img/<?php echo $portfolio_img_bg; ?>" class="portfolio-link" data-lightbox="web-design" 
